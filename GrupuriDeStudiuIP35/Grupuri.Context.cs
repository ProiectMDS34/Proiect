...
namespace GrupuriDeStudiuIP35
{
    ...
    public partial class GrupuriDeStudiuEntities : DbContext
    {
        public GrupuriDeStudiuEntities()
            : base("name=GrupuriDeStudiuEntities")
        {
        }
        ...
        public virtual DbSet<DISCUTII> DISCUTIIs { get; set; }
        public virtual DbSet<GRUPURI> GRUPURIs { get; set; }
        ...
        public virtual DbSet<APARTENENTA> APARTENENTAs { get; set; }
